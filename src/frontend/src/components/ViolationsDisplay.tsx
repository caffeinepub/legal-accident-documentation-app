...
import { AlertTriangle, StopCircle, RotateCcw, TrafficCone, CheckCircle } from 'lucide-react';
...
export default function ViolationsDisplay({ violations }: ViolationsDisplayProps) {
              ...
              >
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Detected at {date.toLocaleTimeString()} on {date.toLocaleDateString()}
                  </p>
                </div>
              </div>
            );
