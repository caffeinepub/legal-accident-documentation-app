...
import { ChevronDown, ChevronUp, FileText, Brain, AlertCircle, Activity } from 'lucide-react';
...
export default function ClaimSummaryPanel({ aiAnalysisResult }: ClaimSummaryPanelProps) {
  ...
  const ruleBasedCorrelations = getSimpleCorrelationsForRegions(sampleRegionIds).slice(0, 3);
        ...
        <div className="mt-2 p-4 bg-card border border-border rounded-lg space-y-6">
            ...
            <div className="flex flex-col items-center gap-3 py-6 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Use the <strong>Injury &amp; Damage Photo Analysis</strong> panel below to upload
                  photos and generate an AI-powered incident analysis. The results will appear here
                  as part of your claim summary.
                </p>
              </div>
            </div>
          )}
          ...
          {aiAnalysisResult && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-semibold text-foreground">AI-Generated Incident Analysis</h4>
              ...
              <div className="flex items-start gap-2 p-3 bg-amber-500/10 border border-amber-500/20 rounded-md">
                ...
                <p className="text-xs text-amber-700 dark:text-amber-400">
                  This AI analysis is generated from photographic evidence and is intended to
                  support — not replace — professional medical and legal assessment. Always consult
                  qualified professionals for formal injury and liability determinations.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="border-t border-border pt-4">
            ...
            <p className="text-xs text-muted-foreground mb-3">
              Standard injury-to-crash-type correlations from biomechanical research, shown for
              reference alongside the AI analysis.
            </p>
            <div className="space-y-2">
              {ruleBasedCorrelations.map((corr, i) => (
                <div key={i} className="p-3 bg-muted/20 border border-border rounded-md">
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xs font-medium text-foreground">{corr.crashType}</p>
                    <Badge
                      variant="outline"
                      className={`text-xs ${
                        corr.severity === 'high'
